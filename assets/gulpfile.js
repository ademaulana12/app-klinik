...
const banner = ['/*!\n',
	' * Bootstrap Custom - <%= pkg.title %> v<%= pkg.version %> (<%= pkg.homepage %>)\n',
...
function modules() {
	...
	var dataTables = gulp.src([
		...
		'./node_modules/datatables.net-datetime/dist/*.css',
		'./node_modules/datatables.net-datetime/dist/*.js',
		'./node_modules/datatables.net-editor/js/*.js',
		...
		'./node_modules/datatables.net-searchbuilder/js/*.js',
		'./node_modules/datatables.net-searchpanes/js/*.js',
		'./node_modules/datatables.net-select/js/*.js',
	])
		.pipe(gulp.dest('./vendor/datatables'));
	// JSzip
	var jszip = gulp.src('./node_modules/jszip/dist/*.js')
		.pipe(gulp.dest('./vendor/jszip'));
	// PdfMake
	var pdfmake = gulp.src('./node_modules/pdfmake/build/*.js')
